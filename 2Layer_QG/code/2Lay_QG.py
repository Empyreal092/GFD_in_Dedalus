...
# Analysis
snapdata = solver.evaluator.add_file_handler('2LayQG_snap', sim_dt=0.5, max_writes=20)
snapdata.add_task(-(-q1), name='q1')
snapdata.add_task(-(-q2), name='q2')
snapdata.add_task(-(-psi1), name='psi1')
snapdata.add_task(-(-psi2), name='psi2')

diagdata = solver.evaluator.add_file_handler('2LayQG_diag', sim_dt=0.01, max_writes=stop_sim_time*100)
